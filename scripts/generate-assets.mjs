#!/usr/bin/env node
/**
 * Generates every brand asset for Quiktap from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"ring","cx":0.5,"cy":0.5,"r":0.41,"w":0.1,"fill":"accentMid"},{"type":"ring","cx":0.5,"cy":0.5,"r":0.25,"w":0.1,"fill":"accent"},{"type":"circle","cx":0.5,"cy":0.5,"r":0.12,"fill":"accentLight"}];
 ...
 */
const MARK = [[0.12,0.12,1,1,0.45],[0.12,0.45,1,0.45,0.12],[0.45,1,1,1,0.45],[0.12,0.45,1,0.45,0.12],[0.45,1,1,0.12,0.12]];
...
console.log('Generating Quiktap brand assets\n');
